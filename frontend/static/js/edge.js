...
function checkModel() {
    if(fs.existsSync('/Users/micheletamborrino/WebstormProjects/iotdash/old_model.sav')){
        console.log("The edge device found a model.")
    }
    else{
        console.log("Model not found. I'm downloading...")
        download('http://127.0.0.1:3000/download', '/Users/micheletamborrino/WebstormProjects/iotdash/old_model.sav')
    }
}
